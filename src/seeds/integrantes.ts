...
const data: Integrante[] = [
    {
        ...
        tags: [
            'Técnico en Tecnología de los Alimentos – EESTN°1 SADA',
            'Trayecto de Formación Pedagógica – ISMA',
            'Docente de Tecnología de los Alimentos – EESTN°1 SADA',
            'Encargado en Laboratorio de Control de Calidad Alimentario y de Aguas – EESTN°1 SADA',
            'Encargado en Laboratorio de Análisis Bioquímico Agrícola – EESAN°1 Martín Fierro',
            'Capacitador en Cursos No Formales – EESAN°1 Martín Fierro'
        ]
    },
    {
        name: 'Luis López',
        ...
        tags: [
            ...
            'Mecánico – Agromecánica Mazziniani',
            'Docente de Electromecánica – EESTN°1 SADA',
            'Mantenimiento Industrial – Hielo Cristal SA',
            'Técnico Operador – Power Box',
            'Mantenimiento Eléctrico y Mecánico de Generadores Eléctricos – Cuenta Propia',
            'Maquinista Operador – Americold Logistic'
        ]
    },
    {
        name: 'Julián Bannon',
        ...
        tags: [
            'Contador Público – UNLu',
            'Estudiante del Posgrado en Digital Accounting – UCEMA',
            'Analista Administrativo – Grupo Vocaturo SRL',
            'Senior de Auditoría Externa – Ernst & Young (EY)'
        ]
    },
    {
        ...
        tags: [
            'Técnico en Electromecánica – EESTN°1 SADA',
            'Técnico Universitario en Mantenimiento Industrial – UTN FRD',
            'Postítulo en Formación Docente para Nivel Secundario – Vocación Docente',
            'Estudiante de Ingeniería Industrial – UNLu',
            'Electricista Domiciliario – SL Multiser',
            'Sector de Repuestos – Ratto Hnos',
            'Docente de Electromecánica – EESTN°1 SADA'
        ]
    },
    {
        ...
        tags: [
            'Técnico en Electromecánica – EESTN°1 SADA',
            'Pasante como Desarrollador Front End – PPOL',
            'Desarrollador Web Full Stack – SoyHenry',
            'Asistente de Enseñanza – SoyHenry',
            'Desarrollador Web Full Stack – Hueney Ruca',
            'Desarrollador Web Front End – Ppol'
        ]
    },
    {
        name: 'Bruno Di Santo',
        description: 'Brindé apoyo y soporte constante técnico electrónico en\n' +
            ...
            '        ',
        tags: [
            'Estudiante de Tecnicatura en Electrónica – Radio Instituto',
            'Electrónica y Electricidad – Cuenta Propia',
            'Comunicaciones – Oscar Martinelli'
        ]
    },
    {
        name: 'Laureano López',
        ...
        tags: [
            ...
            'Operador de Generadores Diesel – Juan F. Secco'
        ]
    },
    {
        name: 'Gonzalo Perone',
        ...
        tags: [
            'Técnico en Electromecánica – EESTN°1 SADA',
            'Técnico Superior en Seguridad e Higiene – ISFT N°143',
            'Administrativo Municipal – Secretaría de Turismo y Cultura',
            'Técnico Matriculado – Colegio de Técnicos de la Pca. De BS.AS'
        ]
    },
    {
        name: 'Mateo Saulino',
        description: 'Con la carrera de Técnico en Electromecánica en curso, realicé actividades de\n' +
            ...
            '        Del Sur.        Domiciliario en SL Multiser.',
        tags: [
            'Técnico en Electromecánica – EESTN°1 SADA',
            'Electricista Domiciliario – SL Multiser',
            'Mantenimiento Industrial – Lasfor',
            'Mantenimiento Industrial – Grupo Agroindustrial Del Sur'
        ]
    },
    {
        ...
        tags: [
            'Técnico Universitario en Mantenimiento Industrial – UTN FRD',
            'Departamento Técnico - Rulemanes Oscar'
        ]
    },
    {
        name: 'Alex Gómez',
        ...
        tags: [
            'Técnico en Electromecánica – EESTN°1 BBME. MITRE',
            'Estudiante de Ingeniería Civil – UTN FRR.',
            'Logística – Crear Soluciones'
        ]
    },
    {
